import"./main-b28f6a90.js";import"./user_nav-b8e04adf.js";import{l as m}from"./index-972ae5fb.js";import{F as b}from"./favorites-858cd1c0.js";import"https://cdn.jsdelivr.net/npm/aos@2.3.4/+esm";import"./course-f55b6d4c.js";const x=document.querySelector(".notebook"),f=document.querySelector(".book-left"),g=document.querySelector(".boot-right"),y=document.querySelector(".pc-marks"),$=document.querySelector(".h5-marks");let v,e,r,p;async function w(){try{m(),await h(),m(e),r=Object.keys(e)[0],l(i(e,1,r)),d()}catch(a){console.log(a)}}w();async function h(){v=await b.getUserFavorites(),e=v.reduce((a,s)=>(a[s.course.platform]?a[s.course.platform].push(s):a.其他平台.push(s),a),{六角學院:[],Hahow:[],Udemy:[],Coursera:[],其他平台:[]})}x.addEventListener("click",a=>{const{page:s}=a.target.dataset;s&&(p=Number(s),l(i(e,p,r)))});function l(a){const{currentPage:s,totalPages:n,data:o}=a;f.innerHTML=`
