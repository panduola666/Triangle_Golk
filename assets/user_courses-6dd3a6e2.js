import{U as x}from"./main-4c0e2c7d.js";import"./user_nav-b8e04adf.js";import{l as v}from"./index-67a1f798.js";import{C as S}from"./comment-0c515d44.js";import{P as w}from"./passes-6cca1e0b.js";import"https://cdn.jsdelivr.net/npm/aos@2.3.4/+esm";import"./course-4f13abac.js";const j=document.querySelector(".notebook"),P=document.querySelector(".book-left"),L=document.querySelector(".boot-right"),M=document.querySelector(".comment-modal"),f=document.querySelector(".pc-marks"),$=document.querySelector(".h5-marks");let g,y,o,l;async function q(){try{v(),g=await w.getUserPasses(),y=await x.getUserInfo(),o=g.reduce((a,s)=>{const e={...s,comment:y.comments.find(n=>n.courseId===s.courseId)||{}};return a[s.course.platform]?a[s.course.platform].push(e):a.其他平台.push(e),s.isFinish&&a.已完課.push(e),a},{六角學院:[],Hahow:[],Udemy:[],Coursera:[],其他平台:[],已完課:[]}),v(o),l=Object.keys(o)[0],d(u(o,1,l)),p()}catch(a){console.log(a)}}q();j.addEventListener("click",a=>{const{page:s}=a.target.dataset;s&&d(u(o,Number(s),l))});function d(a){console.log(a);const{currentPage:s,totalPages:e,data:n}=a;P.innerHTML=`
